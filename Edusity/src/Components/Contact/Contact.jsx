...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "4f308252-7fd1-4e1c-b11f-da84a4b48a0c");
    ...
    <div className="contact">
      ...
      <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            <button type='submit' className='btn dark-btn submit-btn'>Submit Now <img src={arrow_icon} alt="" /></button>
        </form>
        <span>{result}</span>
      </div>
    </div>
